...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 16 2023 г., 23:58
...
CREATE TABLE `категория` (
  `id_ct` int(11) NOT NULL COMMENT 'id категории',
  `название` varchar(255) NOT NULL COMMENT 'название категории'
...
INSERT INTO `категория` (`id_ct`, `название`) VALUES
(1, 'шоколадный'),
(2, 'ягодный'),
(3, 'классический'),
(4, 'ореховый');
...
(1, 'красный бархат', 2, 'красный бисквит, сливочный творожный крем и конфи из ягод на выбор: клубника, вишня, малина'),
(2, 'чёрный лес', 1, 'шоколадный бисквит, два вида крема сливочно-творожный и шоколадный, в прослойке ягоды вишни'),
(3, 'молочная девочка', 2, 'белые коржи на сгущенке, сливочно-творожный крем, в прослойке ягодный джем на выбор: клубника, малина, вишня'),
(4, 'сникерс', 4, 'шоколадный бисквит, крем - взбитый шоколадный ганаш, в прослойке соленая карамель и дробленый арахис'),
(5, 'птичье молоко', 3, 'белый бисквит, нежной сливочное суфле и шоколадная глазировка'),
(6, 'медовик', 3, 'медовые коржи и нежный сметанный крем'),
(7, 'рыжик', 3, 'медовые коржи и нежный заварной крем на сгущенке'),
(8, 'шоколадный медовик', 1, 'шоколадные медовые коржи и нежный сметанный крем');
...
--
ALTER TABLE `категория`
  MODIFY `id_ct` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id категории', AUTO_INCREMENT=5;
...
--
-- Ограничения внешнего ключа таблицы `торты`
--
ALTER TABLE `торты`
  ADD CONSTRAINT `торты_ibfk_1` FOREIGN KEY (`категория`) REFERENCES `категория` (`id_ct`);
COMMIT;
